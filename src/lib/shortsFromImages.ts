...
- 【중요】 마지막 장면을 뺀 나머지는 문장을 끝내지 마라. "~했는데", "~더니", "~길래",
  "~는 거임", "~더라고?" 같은 연결어미로 다음 장면에 말을 넘겨라. 종결어미로 끊으면
  읽을 때 매 장면이 뚝뚝 끊겨 들리고 시청자가 거기서 빠져나간다. 전체가 한 사람이
  쉬지 않고 이어 말하는 한 덩어리처럼 읽혀야 하고, 딱 끝맺는 건 마지막 장면 하나뿐이다.
  나쁜 예: "제주에서 노을을 병에 담아봤다" (끝나버림)
  좋은 예: "제주에서 노을을 병에 담아봤는데" (다음으로 넘어감)
