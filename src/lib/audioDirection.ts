...
【사운드 연출】
- BGM은 전체 이야기의 주된 감정과 속도에 맞춘다. 여행/일상은 travel/chill/warm, 정보 전달은 documentary, 애틋함은 sad/romantic, 장난은 comedy/playful, 실제 위기만 action/horror를 고려한다. 장르를 무작위로 고르지 마라.
